...
class TestSolver:
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("2x^2 - 10x + 3 = -10 + 10x + x^2",
             ([(2.0, 'x', 2.0), (-10.0, 'x', 1), (3.0, '', 0)], [(10.0, '', 0), (-10.0, 'x', 1), (-1, 'x', 2.0)]))
        ]
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("2x - 6 = 0", [3]),
            ("2x^2 - 10x + 3 = -10 + 10x + x^2", [(19.327379053088816), (0.6726209469111843)]),
            # как сделать чтобы работало для 19.3 и 0.67
